...
import com.pstack.rsearch.model.CreateDocTypeFailure;
import com.pstack.rsearch.model.CreateDocTypeSuccess;
import com.pstack.rsearch.model.CreateDocumentFailure;
import com.pstack.rsearch.model.CreateDocumentSuccess;
import com.pstack.rsearch.model.CreateIndexFailure;
import com.pstack.rsearch.model.CreateIndexSuccess;
import com.pstack.rsearch.model.DeleteDocumentFailure;
import com.pstack.rsearch.model.DeleteDocumentSuccess;
import com.pstack.rsearch.model.DeleteIndexFailure;
import com.pstack.rsearch.model.DeleteIndexSuccess;
import com.pstack.rsearch.model.Document;
import com.pstack.rsearch.model.DocumentType;
import com.pstack.rsearch.model.GetDocTypeFailure;
import com.pstack.rsearch.model.GetDocTypeSuccess;
import com.pstack.rsearch.model.GetDocTypesFailure;
import com.pstack.rsearch.model.GetDocTypesSuccess;
import com.pstack.rsearch.model.GetDocumentFailure;
import com.pstack.rsearch.model.GetDocumentSuccess;
import com.pstack.rsearch.model.GetDocumentsFailure;
import com.pstack.rsearch.model.GetDocumentsSuccess;
import com.pstack.rsearch.model.GetIndexFailure;
import com.pstack.rsearch.model.GetIndexSuccess;
import com.pstack.rsearch.model.GetIndexesFailure;
import com.pstack.rsearch.model.GetIndexesSuccess;
import com.pstack.rsearch.model.SearchFailure;
import com.pstack.rsearch.model.SearchQuery;
import com.pstack.rsearch.model.SearchSuccess;
import com.pstack.rsearch.model.SuggestFailure;
import com.pstack.rsearch.model.SuggestQuery;
import com.pstack.rsearch.model.SuggestSuccess;
...
public class RsearchApi {
  ...
  */
  public GetDocumentsSuccess getAllDocuments (String indexName, String docTypeName) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'indexName' is set
    if (indexName == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'indexName' when calling getAllDocuments",
        new ApiException(400, "Missing the required parameter 'indexName' when calling getAllDocuments"));
    }
    // verify the required parameter 'docTypeName' is set
    if (docTypeName == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'docTypeName' when calling getAllDocuments",
        new ApiException(400, "Missing the required parameter 'docTypeName' when calling getAllDocuments"));
    }

    // create path and map variables
    String path = "/indexes/{index_name}/document_types/{doc_type_name}/documents".replaceAll("\\{" + "index_name" + "\\}", apiInvoker.escapeString(indexName.toString())).replaceAll("\\{" + "doc_type_name" + "\\}", apiInvoker.escapeString(docTypeName.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (GetDocumentsSuccess) ApiInvoker.deserialize(localVarResponse, "", GetDocumentsSuccess.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void getAllDocuments (String indexName, String docTypeName, final Response.Listener<GetDocumentsSuccess> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/indexes/{index_name}/document_types/{doc_type_name}/documents".replaceAll("\\{format\\}","json").replaceAll("\\{" + "index_name" + "\\}", apiInvoker.escapeString(indexName.toString())).replaceAll("\\{" + "doc_type_name" + "\\}", apiInvoker.escapeString(docTypeName.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((GetDocumentsSuccess) ApiInvoker.deserialize(localVarResponse,  "", GetDocumentsSuccess.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
