...
import com.parallelstack.auth.Authentication;
import com.parallelstack.auth.ApiKeyAuth;
import com.parallelstack.auth.HttpBasicAuth;
import com.parallelstack.request.GetRequest;
import com.parallelstack.request.PostRequest;
import com.parallelstack.request.PutRequest;
import com.parallelstack.request.DeleteRequest;
import com.parallelstack.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    setUserAgent("Swagger-Codegen/1.3.0/android");

    // Setup authentications (key: authentication name, value: authentication).
    INSTANCE.authentications = new HashMap<String, Authentication>();
    INSTANCE.authentications.put("authToken", new ApiKeyAuth("query", "auth_token"));
    INSTANCE.authentications.put("readAppID", new ApiKeyAuth("header", "X-RSearch-App-ID"));
    INSTANCE.authentications.put("writeAppID", new ApiKeyAuth("header", "X-RSearch-App-ID"));
