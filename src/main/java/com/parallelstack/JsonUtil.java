...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("AlgorithmFailure".equalsIgnoreCase(className)) {
      return new TypeToken<List<AlgorithmFailure>>(){}.getType();
    }
    
    if ("AlgorithmFailureSearchResults".equalsIgnoreCase(className)) {
      return new TypeToken<List<AlgorithmFailureSearchResults>>(){}.getType();
    }
    
    if ("AlgorithmSuccess".equalsIgnoreCase(className)) {
      return new TypeToken<List<AlgorithmSuccess>>(){}.getType();
    }
    
    if ("AlgorithmSuccessAlgorithmResults".equalsIgnoreCase(className)) {
      return new TypeToken<List<AlgorithmSuccessAlgorithmResults>>(){}.getType();
    }
    
    if ("AlgorithmSuccessAlgorithmResultsMetadata".equalsIgnoreCase(className)) {
      return new TypeToken<List<AlgorithmSuccessAlgorithmResultsMetadata>>(){}.getType();
    }
    ...
    if ("IndexesSearchQuery".equalsIgnoreCase(className)) {
      return new TypeToken<List<IndexesSearchQuery>>(){}.getType();
    }
    
    if ("IndexesSearchQuerySearch".equalsIgnoreCase(className)) {
      return new TypeToken<List<IndexesSearchQuerySearch>>(){}.getType();
    }
    
    if ("IndexesSuggestQuery".equalsIgnoreCase(className)) {
      return new TypeToken<List<IndexesSuggestQuery>>(){}.getType();
    }
    
    if ("IndexesSuggestQuerySuggest".equalsIgnoreCase(className)) {
      return new TypeToken<List<IndexesSuggestQuerySuggest>>(){}.getType();
    }
    ...
    if ("SearchFailureSearchResults".equalsIgnoreCase(className)) {
      return new TypeToken<List<SearchFailureSearchResults>>(){}.getType();
    }
    ...
    if ("SearchSuccessSearchResults".equalsIgnoreCase(className)) {
      return new TypeToken<List<SearchSuccessSearchResults>>(){}.getType();
    }
    
    if ("SearchSuccessSearchResultsMetadata".equalsIgnoreCase(className)) {
      return new TypeToken<List<SearchSuccessSearchResultsMetadata>>(){}.getType();
    }
    ...
    if ("SuggestFailureSuggestResults".equalsIgnoreCase(className)) {
      return new TypeToken<List<SuggestFailureSuggestResults>>(){}.getType();
    }
    
    if ("SuggestFailureSuggestResultsMetadata".equalsIgnoreCase(className)) {
      return new TypeToken<List<SuggestFailureSuggestResultsMetadata>>(){}.getType();
    }
    ...
    if ("SuggestSuccessSuggestResults".equalsIgnoreCase(className)) {
      return new TypeToken<List<SuggestSuccessSuggestResults>>(){}.getType();
    }
    
    if ("SuggestSuccessSuggestResultsMetadata".equalsIgnoreCase(className)) {
      return new TypeToken<List<SuggestSuccessSuggestResultsMetadata>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("AlgorithmFailure".equalsIgnoreCase(className)) {
      return new TypeToken<AlgorithmFailure>(){}.getType();
    }
    
    if ("AlgorithmFailureSearchResults".equalsIgnoreCase(className)) {
      return new TypeToken<AlgorithmFailureSearchResults>(){}.getType();
    }
    
    if ("AlgorithmSuccess".equalsIgnoreCase(className)) {
      return new TypeToken<AlgorithmSuccess>(){}.getType();
    }
    
    if ("AlgorithmSuccessAlgorithmResults".equalsIgnoreCase(className)) {
      return new TypeToken<AlgorithmSuccessAlgorithmResults>(){}.getType();
    }
    
    if ("AlgorithmSuccessAlgorithmResultsMetadata".equalsIgnoreCase(className)) {
      return new TypeToken<AlgorithmSuccessAlgorithmResultsMetadata>(){}.getType();
    }
    ...
    if ("IndexesSearchQuery".equalsIgnoreCase(className)) {
      return new TypeToken<IndexesSearchQuery>(){}.getType();
    }
    
    if ("IndexesSearchQuerySearch".equalsIgnoreCase(className)) {
      return new TypeToken<IndexesSearchQuerySearch>(){}.getType();
    }
    
    if ("IndexesSuggestQuery".equalsIgnoreCase(className)) {
      return new TypeToken<IndexesSuggestQuery>(){}.getType();
    }
    
    if ("IndexesSuggestQuerySuggest".equalsIgnoreCase(className)) {
      return new TypeToken<IndexesSuggestQuerySuggest>(){}.getType();
    }
    ...
    if ("SearchFailureSearchResults".equalsIgnoreCase(className)) {
      return new TypeToken<SearchFailureSearchResults>(){}.getType();
    }
    ...
    if ("SearchSuccessSearchResults".equalsIgnoreCase(className)) {
      return new TypeToken<SearchSuccessSearchResults>(){}.getType();
    }
    
    if ("SearchSuccessSearchResultsMetadata".equalsIgnoreCase(className)) {
      return new TypeToken<SearchSuccessSearchResultsMetadata>(){}.getType();
    }
    ...
    if ("SuggestFailureSuggestResults".equalsIgnoreCase(className)) {
      return new TypeToken<SuggestFailureSuggestResults>(){}.getType();
    }
    
    if ("SuggestFailureSuggestResultsMetadata".equalsIgnoreCase(className)) {
      return new TypeToken<SuggestFailureSuggestResultsMetadata>(){}.getType();
    }
    ...
    if ("SuggestSuccessSuggestResults".equalsIgnoreCase(className)) {
      return new TypeToken<SuggestSuccessSuggestResults>(){}.getType();
    }
    
    if ("SuggestSuccessSuggestResultsMetadata".equalsIgnoreCase(className)) {
      return new TypeToken<SuggestSuccessSuggestResultsMetadata>(){}.getType();
    }
